(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './Repeat', './Delete', './Check', './Eye', './QrCode', './Edit', './Close', './Copy', './Gear', './Add', './Search', './Ledger', './Logo', './ArrowLeft', './ArrowRight'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./Repeat'), require('./Delete'), require('./Check'), require('./Eye'), require('./QrCode'), require('./Edit'), require('./Close'), require('./Copy'), require('./Gear'), require('./Add'), require('./Search'), require('./Ledger'), require('./Logo'), require('./ArrowLeft'), require('./ArrowRight'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Repeat, global.Delete, global.Check, global.Eye, global.QrCode, global.Edit, global.Close, global.Copy, global.Gear, global.Add, global.Search, global.Ledger, global.Logo, global.ArrowLeft, global.ArrowRight);
    global.index = mod.exports;
  }
})(this, function (exports, _Repeat, _Delete, _Check, _Eye, _QrCode, _Edit, _Close, _Copy, _Gear, _Add, _Search, _Ledger, _Logo, _ArrowLeft, _ArrowRight) {
  'use strict';
