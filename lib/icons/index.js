(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './Repeat', './Delete', './Eye', './QrCode', './Edit', './Close', './Copy', './Gear', './Add', './Search', './Ledger', './Logo'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./Repeat'), require('./Delete'), require('./Eye'), require('./QrCode'), require('./Edit'), require('./Close'), require('./Copy'), require('./Gear'), require('./Add'), require('./Search'), require('./Ledger'), require('./Logo'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Repeat, global.Delete, global.Eye, global.QrCode, global.Edit, global.Close, global.Copy, global.Gear, global.Add, global.Search, global.Ledger, global.Logo);
    global.index = mod.exports;
  }
})(this, function (exports, _Repeat, _Delete, _Eye, _QrCode, _Edit, _Close, _Copy, _Gear, _Add, _Search, _Ledger, _Logo) {
  'use strict';
