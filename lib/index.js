(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './components/Account', './components/Address', './components/IdentityIcon', './components/SyncWarning', './components/Warning', './components/CreateTransaction', './components/Input', './components/Page', './components/ToggledIconButton', './components/TransactionButton', './components/AppBar', './theme', './components/AccountSelect', './components/CurrentBlockNumber', './components/EtcBalance', './smart-components/NetworkSelector', './providers/EmeraldProvider', './providers/EthJsonRpcProvider', './providers/EthRpc', './providers/VaultJsonRpcProvider', './providers/VaultRpc', './providers/Contract', './providers/TransactionUri'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./components/Account'), require('./components/Address'), require('./components/IdentityIcon'), require('./components/SyncWarning'), require('./components/Warning'), require('./components/CreateTransaction'), require('./components/Input'), require('./components/Page'), require('./components/ToggledIconButton'), require('./components/TransactionButton'), require('./components/AppBar'), require('./theme'), require('./components/AccountSelect'), require('./components/CurrentBlockNumber'), require('./components/EtcBalance'), require('./smart-components/NetworkSelector'), require('./providers/EmeraldProvider'), require('./providers/EthJsonRpcProvider'), require('./providers/EthRpc'), require('./providers/VaultJsonRpcProvider'), require('./providers/VaultRpc'), require('./providers/Contract'), require('./providers/TransactionUri'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Account, global.Address, global.IdentityIcon, global.SyncWarning, global.Warning, global.CreateTransaction, global.Input, global.Page, global.ToggledIconButton, global.TransactionButton, global.AppBar, global.theme, global.AccountSelect, global.CurrentBlockNumber, global.EtcBalance, global.NetworkSelector, global.EmeraldProvider, global.EthJsonRpcProvider, global.EthRpc, global.VaultJsonRpcProvider, global.VaultRpc, global.Contract, global.TransactionUri);
    global.index = mod.exports;
  }
})(this, function (exports, _Account, _Address, _IdentityIcon, _SyncWarning, _Warning, _CreateTransaction, _Input, _Page, _ToggledIconButton, _TransactionButton, _AppBar, _theme, _AccountSelect, _CurrentBlockNumber, _EtcBalance, _NetworkSelector, _EmeraldProvider, _EthJsonRpcProvider, _EthRpc, _VaultJsonRpcProvider, _VaultRpc, _Contract, _TransactionUri) {
  'use strict';
  ...
  Object.defineProperty(exports, 'TransactionUri', {
    enumerable: true,
    get: function () {
      return _interopRequireDefault(_TransactionUri).default;
    }
  });
