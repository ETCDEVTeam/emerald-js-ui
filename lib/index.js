(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './components/Account', './components/Address', './components/IdentityIcon', './components/Card', './components/Checkbox', './components/Button', './components/LinkButton', './components/ButtonGroup', './components/SyncWarning', './components/Input', './components/Warning', './components/SelectField', './components/SelectAddressInput', './components/CreateTransaction', './components/Page'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./components/Account'), require('./components/Address'), require('./components/IdentityIcon'), require('./components/Card'), require('./components/Checkbox'), require('./components/Button'), require('./components/LinkButton'), require('./components/ButtonGroup'), require('./components/SyncWarning'), require('./components/Input'), require('./components/Warning'), require('./components/SelectField'), require('./components/SelectAddressInput'), require('./components/CreateTransaction'), require('./components/Page'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Account, global.Address, global.IdentityIcon, global.Card, global.Checkbox, global.Button, global.LinkButton, global.ButtonGroup, global.SyncWarning, global.Input, global.Warning, global.SelectField, global.SelectAddressInput, global.CreateTransaction, global.Page);
    global.index = mod.exports;
  }
})(this, function (exports, _Account, _Address, _IdentityIcon, _Card, _Checkbox, _Button, _LinkButton, _ButtonGroup, _SyncWarning, _Input, _Warning, _SelectField, _SelectAddressInput, _CreateTransaction, _Page) {
  'use strict';
