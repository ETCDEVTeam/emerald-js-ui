    ...
    _createClass(Input, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['value', 'underlineShow', 'className', 'multiLine', 'rowsMax', 'rows', 'disabled', 'classes', 'containerStyle']);
        ...
        if (value) {
          return _react2.default.createElement(
            'div',
            { style: _extends({}, styles, containerStyle), className: classes.container },
