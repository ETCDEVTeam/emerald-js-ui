(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '@material-ui/core/styles', '@material-ui/core/Toolbar', '@material-ui/core/AppBar', '../Account', '../Address', '@material-ui/core/Typography', '@material-ui/core/IconButton', '../../icons3'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('@material-ui/core/styles'), require('@material-ui/core/Toolbar'), require('@material-ui/core/AppBar'), require('../Account'), require('../Address'), require('@material-ui/core/Typography'), require('@material-ui/core/IconButton'), require('../../icons3'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.styles, global.Toolbar, global.AppBar, global.Account, global.Address, global.Typography, global.IconButton, global.icons3);
    global.AppBar = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _styles, _Toolbar, _AppBar, _Account, _Address, _Typography, _IconButton, _icons) {
  'use strict';
