(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'copy-to-clipboard', '@material-ui/core/styles', '../ToggledIconButton', '../../icons3'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('copy-to-clipboard'), require('@material-ui/core/styles'), require('../ToggledIconButton'), require('../../icons3'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.copyToClipboard, global.styles, global.ToggledIconButton, global.icons3);
    global.Address = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _copyToClipboard, _styles, _ToggledIconButton, _icons) {
  'use strict';
  ...
  var Address = exports.Address = function (_React$Component) {
    ...
    _createClass(Address, [{
      ...
      value: function render() {
        ...
        var addressClassname = classes.address + shortened ? classes.shortenedAddress : '';
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_ToggledIconButton2.default, {
            onClick: this.onCopyClick,
            icon: _react2.default.createElement(_icons.Copytoclipboard, null),
            toggledIcon: _react2.default.createElement(_icons.Check1, null)
          })
        );
      }
    }, {
