(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'copy-to-clipboard', 'react-jss', 'material-ui/styles/muiThemeable', '../../icons3', './styles'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('copy-to-clipboard'), require('react-jss'), require('material-ui/styles/muiThemeable'), require('../../icons3'), require('./styles'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.copyToClipboard, global.reactJss, global.muiThemeable, global.icons3, global.styles);
  ...
  var Address = exports.Address = function (_React$Component) {
    ...
    _createClass(Address, [{
      ...
      value: function render() {
        ...
        var icons = null;
        if (!shortened) {
          icons = _react2.default.createElement(_icons.Copytoclipboard, {
        ...
        if (this.state.showCheck) {
          icons = _react2.default.createElement(_icons.Check1, { style: { color: muiTheme.palette.primary1Color } });
        }
        ...
        return _react2.default.createElement(
          'div',
          { className: classes.container, style: finalStyle },
          _react2.default.createElement(
            'div',
            { onClick: onClick, className: classes.address },
            value
          ),
          !hideCopy && icons && _react2.default.createElement(
            'div',
            null,
            icons
          )
