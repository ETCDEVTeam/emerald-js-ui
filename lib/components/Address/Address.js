(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'copy-to-clipboard', 'react-jss', '../../icons2', './styles'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('copy-to-clipboard'), require('react-jss'), require('../../icons2'), require('./styles'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.copyToClipboard, global.reactJss, global.icons2, global.styles);
    ...
    _createClass(Address, [{
      ...
      value: function render() {
        ...
        if (this.state.showCheck) {
          icons = _react2.default.createElement(_icons.CheckCircle, { color: 'green' });
        }
