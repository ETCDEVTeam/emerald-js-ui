(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '@material-ui/core/Button', './FormFieldWrapper', './FromField', './TokenField', './ToField', './AmountField', './GasLimitField'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('@material-ui/core/Button'), require('./FormFieldWrapper'), require('./FromField'), require('./TokenField'), require('./ToField'), require('./AmountField'), require('./GasLimitField'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.Button, global.FormFieldWrapper, global.FromField, global.TokenField, global.ToField, global.AmountField, global.GasLimitField);
    global.CreateTransaction = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _Button, _FormFieldWrapper, _FromField, _TokenField, _ToField, _AmountField, _GasLimitField) {
  'use strict';
