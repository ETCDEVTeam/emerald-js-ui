(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    global.BlockNumber = mod.exports;
  }
  ...
  var BlockNumber = function (_React$Component) {
    _inherits(BlockNumber, _React$Component);

    function BlockNumber() {
      _classCallCheck(this, BlockNumber);

      return _possibleConstructorReturn(this, (BlockNumber.__proto__ || Object.getPrototypeOf(BlockNumber)).apply(this, arguments));
    }
  ...
  exports.default = (0, _styles.withStyles)(styles, { name: 'EmeraldBlockNumber' })(BlockNumber);
});