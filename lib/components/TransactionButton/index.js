  ...
  var TransactionButton = function (_React$Component) {
    ...
    _createClass(TransactionButton, [{
      ...
      value: function render() {
        return _react2.default.createElement(_Button2.default, { primaryText: this.props.primaryText || 'Send Transaction', href: this.state.transactionLink, variant: 'contained' });
      }
    }]);
