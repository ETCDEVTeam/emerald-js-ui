(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-jss', '../../icons', '../Address', '../IdentityIcon', './styles'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-jss'), require('../../icons'), require('../Address'), require('../IdentityIcon'), require('./styles'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactJss, global.icons, global.Address, global.IdentityIcon, global.styles);
  ...
  var showIdentity = function showIdentity(show, id, identityProps) {
    if (show) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_IdentityIcon2.default, _extends({ id: id }, identityProps))
      );
    }
    return null;
  };
  ...
  var Account = exports.Account = function Account(props) {
    ...
    return _react2.default.createElement(
      'div',
      { style: { display: 'flex', flexDirection: 'row', alignItems: 'center' }, className: classes.container },
  ...
  Account.propTypes = {
    ...
    identityProps: _propTypes2.default.bool,
